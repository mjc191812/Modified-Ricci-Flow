...
# Define the RhoCurvature class, including curvature calculation and flow computation
...
G = nx.read_gexf((r"C:\Users\Administrator\Desktop\test\test1\data\original\karate.gexf"))
# Make a copy to preserve the original data
G_1 = G.copy()
_rc = RhoCurvature(G_1)
_rc.compute_ricci_curvature()
show_results(_rc.G)
_rc.compute_ricci_flow(iterations=50, step=0.01, delta=1e-6, surgery={'name':'surgery', 'portion': 0.03, 'interval': 10})
G_2=check_accuracy(_rc.G,clustering_label="club",plot_cut=False)
